...
| [ADR-0009](0009-agent-side-evidence-gathering-and-fleet-correlation.md) | Evidence gathering moves to the agent; the server's job becomes fleet-wide correlation | Accepted | [agent](../components/agent/README.md), [server](../components/server/README.md), [mesh-mcp](../components/mesh-mcp/README.md); supersedes the server-side placement in [ADR-0006](0006-mcp-evidence-enrichment.md) |
