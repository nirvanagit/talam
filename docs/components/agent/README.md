...
**Related:** reads [`ADR-0001`](../../decisions/0001-server-agent-operator-split.md), [`ADR-0005`](../../decisions/0005-crd-native-incidents-and-resolutions.md), [`ADR-0007`](../../decisions/0007-agent-never-applies-remediation.md), [`../../concepts/analyzer-interface.md`](../../concepts/analyzer-interface.md), [`../../concepts/finding-and-incident.md`](../../concepts/finding-and-incident.md), [`../../concepts/remediation-flow.md`](../../concepts/remediation-flow.md); links to [`../operator/README.md`](../operator/README.md), [`../server/README.md`](../server/README.md), [`../../api/analyzer-catalog.md`](../../api/analyzer-catalog.md), [`../../api/crds.md`](../../api/crds.md#meshincident--meshresolution), [`../../concepts/object-model.md`](../../concepts/object-model.md)
...
| Resolution reconciler | Watches local `MeshResolution` objects for `status.outcome` becoming non-empty — set by whatever **external system** applied the patch, never by the agent itself ([ADR-0007](../../decisions/0007-agent-never-applies-remediation.md)) — and relays it to talam-server (`POST /v1/proposals/{id}/outcome`). It never touches a mesh resource; the agent holds no write RBAC on any Istio CRD. |
| Incident reconciler | Watches local `MeshIncident` objects and rolls up `status.complete` from the `MeshResolution` objects referencing each one (true once every referenced resolution has a non-empty `status.outcome`), entirely locally, no server round-trip needed. |
