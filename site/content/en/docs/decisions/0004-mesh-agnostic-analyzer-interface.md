---
title: "ADR-0004: Analyzer interface is mesh-agnostic; Istio ships as the first backend"
weight: 40
---
**Status:** Accepted
**Related:** reads [`../concepts/analyzer-interface.md`](/docs/concepts/analyzer-interface/)
