---
title: "ADR-0001: Split into server, agent, and operator instead of one binary"
weight: 10
---
**Status:** Accepted
**Related:** affects [`../components/operator/README.md`](/docs/components/operator/), [`../components/agent/README.md`](/docs/components/agent/), [`../components/server/README.md`](/docs/components/server/); see [`../architecture/overview.md#system-topology`](/docs/architecture/#system-topology)
