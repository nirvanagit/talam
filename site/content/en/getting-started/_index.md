...
weight: 5
description: "Install talam, run your first scan, and approve a remediation."
---
...
- **[Read the docs]({{< relref "/docs" >}})** — understand the architecture and design decisions
- **[Explore the API]({{< relref "/docs/api/crds" >}})** — all CRD schemas and configuration options
- **[Set up MCP]({{< relref "/docs/components/mesh-mcp" >}})** — enable evidence enrichment for smarter proposals
- **[Contribute]({{< relref "/contribute" >}})** — add analyzers, fix bugs, write docs
