...
title: "Changelog"
weight: 9
description: "Release notes, breaking changes, and upgrade guides."
---
...
- Hugo + Docsy website (GitHub Pages ready)
...
### From earlier pre-release versions

There is no v0.0.x. v0.1.0 is the first release. If you ran a pre-release version on your cluster, delete all talam resources before upgrading:

```bash
kubectl delete ns talam-system
kubectl delete crd meshincidents.talam.io meshresolutions.talam.io meshdiagnostics.talam.io
```

Then follow the [Getting Started guide]({{< relref "/getting-started" >}}).
...
Do **not** open a public issue for security vulnerabilities. Email [security@example.com](mailto:security@example.com) with:
