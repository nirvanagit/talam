...
title: "Design System"
weight: 6
description: "Brand, visual identity, and design principles for talam."
---
...
The site uses [Hugo](https://gohugo.io/) + [Docsy](https://www.docsy.dev/) theme:

- **Hero color:** Gradient from `#0f766e` → `#0891b2` → `#075985`
- **Logo:** Teal mesh triangle, 30px icon in navbar
- **Accent links:** `#0f766e` with underline on hover
- **Code blocks:** Syntax highlighting with `tango` theme

See [hugo.toml](https://github.com/nirvanagit/talam/blob/main/site/hugo.toml) for theme configuration.
